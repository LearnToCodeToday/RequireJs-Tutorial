...
var searchWorldLanguages = function () {
    ...
    function _isValidCountryCodeSearch() {
        ...
        var myAphpaRegex = /^[A-Z|a-z]{1,}$/;

        if (myAphpaRegex.test(countryCodeValue)) {
            return true;
        }
        return false;
    }
    ...
    function _addEvent() {
        ...
        if (_isValidCountryCodeSearch()) {
            var countryCodeValue = $("#txtLanCodeName").val();

            var matchingCountryLanguages = displayCountryInfo(countryCodeValue);
            bindViews(matchingCountryLanguages);
        }
        else {
    ...
    function assignEvents() {
        $("#btnSearch").click(_addEvent);
        $("#txtLanCodeName").keyup(_addEvent);
    }


    function bindViews(matchingLanguages) {
